...
export default function PostDetailsThree({ id }) {
      ...
      async function fetchNewsItem() {
        try {
          ...
          if (response.ok) {
            ...
            console.error('Failed to fetch news item:', response.statusText);
          }
        } catch (error) {
  ...
  const sanitizedContent = DOMPurify.sanitize(newsItem.NEWS_CONTENT);
  return (
    <Layout>
                  ...
                  <div className="post-content">
                    ...
                    <div className="post-author">
                      <div className="author-info">
                        <div className="thumb">
                        <img src={`https://www.gujaratpost.in/news/${newsItem.NEWS_IMAGE}`} alt="trending" />
                        </div>
